...
@section('title', 'Job Category Show')
@section('content')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Job Category Show</h1>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="name"
                                           value="{{ old('name', $jobCategory->name) }}" name="name" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="icon"
                                           ...
                                           value="{{ old('icon', $jobCategory->icon) }}" name="icon" disabled>
                                </div>
                            </div>
