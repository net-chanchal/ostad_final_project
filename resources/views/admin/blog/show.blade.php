        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">Blog Show</div>
                </div>
            </div>
                        ...
                        <form action="" method="POST"
                            ...
                            <div class="form-group row">
                                <label for="blog_category_id" class="col-sm-3 col-form-label text-right">Category
                                    *</label>
                                <div class="col-sm-6">
                                    <select name="blog_category_id" id="blog_category_id" class="form-control" disabled>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="title"
                                           value="{{ old('title', $blog->title) }}" name="title" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="slug"
                                           value="{{ old('slug', $blog->slug) }}" name="slug" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="datetime-local" class="form-control" id="posted_on" disabled
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="posted_by"
                                           value="{{ old('posted_by', $blog->posted_by) }}" name="posted_by" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="short_description" class="col-sm-3 col-form-label text-right">Short
                                    Description *</label>
                                <div class="col-sm-6">
                                    <textarea name="short_description" id="short_description" disabled
