@php use App\Helpers\CoreHelper;use Illuminate\Support\Carbon; @endphp
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                            @foreach($jobPost->jobApplies as $apply)
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div>
                                                @if (!empty($apply->account->avatar_image) && file_exists(public_path("storage/uploads/accounts/{$apply->account->avatar_image}")))
                                                    <img src="{{ asset("storage/uploads/accounts/{$apply->account->avatar_image}") }}"
                                                         width="50"
                                            ...
                                            <div class="ml-2 mt-1">
                                                <b>{{ $apply->account->name }}</b><br>
                                                <a href="{{ route('admin.accounts.show', $apply->account_id) }}"
                                                   target="_blank">
                                    ...
                                    <td>-</td>
                                    <td>{{ Carbon::make($apply->created_at)->format('Y-m-d h:i A') }}</td>
                                    <td>
                                        {!! CoreHelper::status($apply->status, [
                                            'Submitted' => 'warning',
                                            'Under Review' => 'info',
